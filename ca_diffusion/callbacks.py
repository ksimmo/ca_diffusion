...
class ImageLogger(Callback):
    def __init__(self, batch_frequency, max_images, clamp=True, increase_log_steps=True,
                 ...
                 log_images_kwargs=None, batchrow=False, log_val=True, log_val_epochs=1, save_local=True, save_logger=True):
        super().__init__()
    ...
    def _tensorboard(self, pl_module, images, batch_idx, split):
        for k in images:
            ...
            if self.batchrow and len(imgs.size()) == 5:
                nrow = imgs.size(2)
    ...
    def log_local(self, save_dir, split, images,
        ...
        for k in images:
            ...
            #if imgs.size(1)==1: #in case we only have 1 channel
